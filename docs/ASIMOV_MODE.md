...
|------|---------|--------------|
| `warmup.yaml` | Full protocol rules | `asimov-mode init` |
| `sprint.yaml` | Session boundaries | `asimov-mode init --full` |
| `roadmap.yaml` | Milestone planning | `asimov-mode init --full` |
| `CLAUDE.md` | Self-healing trigger | `asimov-mode init --asimov` |
| Pre-commit hooks | Quality enforcement | `asimov-mode init --asimov` |
...
- [CLI Reference](../README.md#cli-validator) - asimov-mode commands
