...
Implement a `forge-protocol refresh` command that outputs protocol reminders, and call it from git pre-commit hooks.
...
```bash
#!/bin/bash
# .hooks/pre-commit (generated by forge-protocol init --skynet)
...
fn cmd_refresh(verbose: bool) -> ExitCode {
    println!();
    println!("═══════════════════════════════════════════════════════════════════════");
    println!("🤖 SKYNET MODE - PROTOCOL REFRESH");
    println!("═══════════════════════════════════════════════════════════════════════");
    println!();
...
pub fn precommit_hook_template(project_type: ProjectType) -> String {
    format!(r#"#!/bin/bash
# Forge Protocol pre-commit hook
